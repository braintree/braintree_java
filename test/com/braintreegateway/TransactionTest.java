...
public class TransactionTest {
    ...
    public void serviceFeeNotAllowedForMasterMerchant() {
        ...
        Assert.assertEquals(ValidationErrorCode.SERVICE_FEE_NOT_SUPPORTED_ON_MASTER_MERCHANT,
    ...
    public void serviceFeeMerchantAccountMustBeAMaster() {
        ...
        Assert.assertEquals(ValidationErrorCode.SERVICE_FEE_MERCHANT_ACCOUNT_MUST_BE_A_MASTER_MERCHANT_ACCOUNT,
    ...
    public void serviceFeeRequiredWhenUsingSubmerchant() {
        ...
        Assert.assertEquals(ValidationErrorCode.TRANSACTION_SUB_MERCHANT_REQUIRES_SERVICE_FEE,
