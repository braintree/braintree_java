...
public class TransparentRedirectRequestTest {
    ...
    public void constructorRaisesForgedQueryStringExceptionIfGivenInvalidQueryString() {
        Configuration configuration = new Configuration("baseMerchantURL", "integration_public_key", "integration_private_key");
        new TransparentRedirectRequest(configuration, "http_status=300&id=6kdj469tw7yck32j&hash=99c9ff20cd7910a1c1e793ff9e3b2d15586dc6b9" + "this makes it invalid");    
    }
    ...
    public void constructorRaisesAuthenticationExceptionIfHttpStatusIs401() {
        Configuration configuration = new Configuration("baseMerchantURL", "integration_public_key", "integration_private_key");
        System.out.println(new Crypto().hmacHash(configuration.privateKey, "http_status=401&id=6kdj469tw7yck32j"));
    ...
    public void constructorRaisesAuthorizatonExcptionIfHttpStatusIs403() {
        Configuration configuration = new Configuration("baseMerchantURL", "integration_public_key", "integration_private_key");
        System.out.println(new Crypto().hmacHash(configuration.privateKey, "http_status=403&id=6kdj469tw7yck32j"));
    ...
    public void constructorRaisesDownForMaintenanceExceptionIfHttpStatusIs503() {
        Configuration configuration = new Configuration("baseMerchantURL", "integration_public_key", "integration_private_key");
        System.out.println(new Crypto().hmacHash(configuration.privateKey, "http_status=503&id=6kdj469tw7yck32j"));
    ...
    public void constructorRaisesNotFoundExceptionIfHttpStatusIs404() {
        Configuration configuration = new Configuration("baseMerchantURL", "integration_public_key", "integration_private_key");
        System.out.println(new Crypto().hmacHash(configuration.privateKey, "http_status=404&id=6kdj469tw7yck32j"));
    ...
    public void constructorRaisesUnexpectedExceptionIfHttpStatusIsUnexpected() {
        Configuration configuration = new Configuration("baseMerchantURL", "integration_public_key", "integration_private_key");
        System.out.println(new Crypto().hmacHash(configuration.privateKey, "http_status=600&id=6kdj469tw7yck32j"));
