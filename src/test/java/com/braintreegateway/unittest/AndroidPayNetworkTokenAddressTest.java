...
import com.braintreegateway.AndroidPayNetworkTokenAddressRequest;
import com.braintreegateway.AndroidPayNetworkTokenRequest;

public class AndroidPayNetworkTokenAddressTest {
    @Test
    public void toXmlIncludesAllElements() throws IOException, SAXException {
        AndroidPayNetworkTokenAddressRequest request = new AndroidPayNetworkTokenAddressRequest(new AndroidPayNetworkTokenRequest()).
