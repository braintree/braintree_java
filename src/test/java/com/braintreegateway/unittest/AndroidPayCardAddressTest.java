...
import com.braintreegateway.AndroidPayCardAddressRequest;
import com.braintreegateway.AndroidPayCardRequest;

public class AndroidPayCardAddressTest {
    @Test
    public void toXmlIncludesAllElements() throws IOException, SAXException {
        AndroidPayCardAddressRequest request = new AndroidPayCardAddressRequest(new AndroidPayCardRequest()).
