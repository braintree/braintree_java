...
public class CreateCustomerSessionGatewayTest {
    ...
    public void testCreateCustomerSession_invokes_GraphQLClient() throws IOException {
        Map<String, Object> successResponse = TestHelper.readResponseFromJsonResource("unittest/customer_session/create_session_successful_response.json");
    ...
    public void testCreateCustomerSession_OnValidationErrors() throws IOException {
        Map<String, Object> errorResponse = TestHelper.readResponseFromJsonResource("unittest/customer_session/create_session_with_errors.json");
    ...
    public void testCreateCustomerSession_OnParsingError() throws IOException {
        Map<String, Object> errorResponse = TestHelper.readResponseFromJsonResource("unittest/customer_session/create_session_unparseable_response.json");
