...
public enum ValidationErrorCode {
    ...
    ANDROID_PAY_CARDS_ARE_NOT_ACCEPTED("83708"),
    ...
    APPLE_PAY_NETWORK_TRANSACTION_ID_NOT_ALLOWED("93532"),
    APPLE_PAY_NUMBER_IS_REQUIRED("93508"),
    APPLE_PAY_OPTIONS_VERIFICATION_ACCOUNT_TYPE_IS_INVALID("93538"),
    APPLE_PAY_OPTIONS_VERIFICATION_ACCOUNT_TYPE_NOT_SUPPORTED("93543"),
    APPLE_PAY_OPTIONS_VERIFICATION_AMOUNT_CANNOT_BE_NEGATIVE("93535"),
    APPLE_PAY_OPTIONS_VERIFICATION_AMOUNT_FORMAT_IS_INVALID("93534"),
    APPLE_PAY_OPTIONS_VERIFICATION_AMOUNT_IS_TOO_LARGE("93537"),
    APPLE_PAY_OPTIONS_VERIFICATION_AMOUNT_NOT_SUPPORTED_BY_PROCESSOR("93536"),
    APPLE_PAY_OPTIONS_VERIFICATION_MERCHANT_ACCOUNT_ID_IS_INVALID("93540"),
    APPLE_PAY_OPTIONS_VERIFICATION_MERCHANT_ACCOUNT_IS_SUSPENDED("93541"),
    ...
    CUSTOMER_INTERNATIONAL_COUNTRY_CODE_IS_INVALID("91625"),
    CUSTOMER_INTERNATIONAL_PHONE_IS_INVALID("91626"),
    ...
    API_REQUEST_KEY_TOO_LONG("915230"),
    API_REQUEST_KEY_NOT_ALLOWED("915231"),
    API_REQUEST_KEY_CAN_BE_REUSED_ONLY_WITH_THE_SAME_REQUEST("915232"),
    API_REQUEST_KEY_IS_IN_FLIGHT("915233"),
    API_REQUEST_KEY_WITH_FAILED_REQUEST("915234"),
    API_REQUEST_KEY_SERVER_ERROR("915235"),
    ...
    PAYPAL_ACCOUNT_EMAIL_FORMAT_IS_INVALID("92963"),
    PAYPAL_ACCOUNT_EMAIL_IS_TOO_LONG("92964"),
    ...
    PAYPAL_PAYMENT_RESOURCE_NONCE_EXPIRED("97301"),
    PAYPAL_PAYMENT_RESOURCE_ID_NOT_SUPPORTED("97302"),
    PAYPAL_PAYMENT_RESOURCE_NONCE_REQUIRED("97303"),
    PAYPAL_PAYMENT_RESOURCE_INVALID_EMAIL("97304"),
    PAYPAL_PAYMENT_RESOURCE_EMAIL_TOO_LONG("97305"),
    PAYPAL_PAYMENT_RESOURCE_EXPECTED_LINE_ITEM_COLLECTION("97306"),
    PAYPAL_PAYMENT_RESOURCE_EXPECTED_LINE_ITEM_HASH("97307"),
    PAYPAL_PAYMENT_RESOURCE_EXPECTED_LINE_ITEM_DEBIT("97308"),
    PAYPAL_PAYMENT_RESOURCE_INVALID_UNIT_AMOUNT("97309"),
    PAYPAL_PAYMENT_RESOURCE_INVALID_UNIT_TAX_AMOUNT("97310"),
    PAYPAL_PAYMENT_RESOURCE_ISO_CODE_REQUIRED("97311"),
    PAYPAL_PAYMENT_RESOURCE_ISO_CODE_UNSUPPORTED("97312"),
    PAYPAL_PAYMENT_RESOURCE_SHIPPING_FIELDS_MISSING("97313"),
    PAYPAL_PAYMENT_RESOURCE_INVALID_AMOUNT_BREAKDOWN("97314"),
    PAYPAL_PAYMENT_RESOURCE_EXPECTED_SHIPPING_OPTION_COLLECTION("97315"),
    PAYPAL_PAYMENT_RESOURCE_SHIPPING_OPTIONS_REQUIRED("97316"),
    PAYPAL_PAYMENT_RESOURCE_SHIPPING_OPTION_FIELDS_MISSING("97317"),
    PAYPAL_PAYMENT_RESOURCE_INVALID_SHIPPING_OPTION_TYPE("97318"),
    PAYPAL_PAYMENT_RESOURCE_SHIPPING_OPTION_ID_REUSED("97319"),
    PAYPAL_PAYMENT_RESOURCE_TOO_MANY_SHIPPING_OPTIONS_SELECTED("97320"),
    PAYPAL_PAYMENT_RESOURCE_SHIPPING_OPTION_MUST_MATCH_BREAKDOWN("97321"),
    PAYPAL_PAYMENT_RESOURCE_LINE_ITEMS_SHOULD_MATCH_TOTAL("97322"),
    PAYPAL_PAYMENT_RESOURCE_LINE_ITEMS_TAX_SHOULD_MATCH_TOTAL("97323"),
    PAYPAL_PAYMENT_RESOURCE_PATCH_CALL_FAILED("97324"),
    PAYPAL_PAYMENT_RESOURCE_INVALID_AMOUNT("97325"),
    PAYPAL_PAYMENT_RESOURCE_SHIPPING_ID_TOO_LONG("97326"),
    PAYPAL_PAYMENT_RESOURCE_SHIPPING_LABEL_TOO_LONG("97327"),
    PAYPAL_PAYMENT_RESOURCE_SHIPPING_FULL_NAME_TOO_LONG("97328"),
    PAYPAL_PAYMENT_RESOURCE_SHIPPING_ADDRESS_TOO_LONG("97329"),
    PAYPAL_PAYMENT_RESOURCE_SHIPPING_EXTENDED_ADDRESS_TOO_LONG("97330"),
    PAYPAL_PAYMENT_RESOURCE_SHIPPING_LOCALITY_TOO_LONG("97331"),
    PAYPAL_PAYMENT_RESOURCE_SHIPPING_REGION_TOO_LONG("97332"),
    PAYPAL_PAYMENT_RESOURCE_COUNTRY_CODE_TOO_LONG("97333"),
    PAYPAL_PAYMENT_RESOURCE_NATIONAL_NUMBER_TOO_LONG("97334"),
    PAYPAL_PAYMENT_RESOURCE_POSTAL_CODE_TOO_LONG("97335"),
    PAYPAL_PAYMENT_RESOURCE_DESCRIPTION_TOO_LONG("97336"),
    PAYPAL_PAYMENT_RESOURCE_CUSTOM_FIELD_TOO_LONG("97337"),
    PAYPAL_PAYMENT_RESOURCE_ORDER_ID_TOO_LONG("97338"),
    ...
    TRANSACTION_CANNOT_CLONE_THIRD_PARTY_COF_NETWORK_TOKEN_TRANSACTION("915274"),
    ...
    TRANSACTION_OPTIONS_SUBMIT_FOR_SETTLEMENT_IS_NOT_SUPPORTED_FOR_NETWORK("915261"),
    ...
    TRANSACTION_ORIGINAL_SALE_TRANSACTION_WAS_NOT_SURCHARGED("97605"),
    TRANSACTION_PAY_PAL_AUTH_EXPIRED("91579"),
    TRANSACTION_PAY_PAL_VAULT_RECORD_MISSING_DATA("91583"),

    TRANSACTION_PAYMENT_FACILITATOR_NOT_APPLICABLE("97405"),
    ...
    TRANSACTION_PROCESSING_MERCHANT_CATEGORY_CODE_IS_INVALID("915265"),
    ...
    TRANSACTION_THREE_D_SECURE_PASS_THRU_NETWORK_DOES_NOT_MATCH_PAYMENT_INSTRUMENT("915139"),
    TRANSACTION_THREE_D_SECURE_PASS_THRU_NETWORK_DOES_NOT_SUPPORT_CURRENCY("915239"),
    TRANSACTION_THREE_D_SECURE_PASS_THRU_NETWORK_DOES_NOT_SUPPORT_MERCHANT_ACCOUNT_CURRENCY("915243"),
    TRANSACTION_THREE_D_SECURE_PASS_THRU_NETWORK_IS_INVALID("915128"),
    ...
    TRANSACTION_TRANSFER_DETAILS_ARE_MANDATORY("97510"),
    TRANSACTION_TRANSFER_DETAILS_ARE_NOT_APPLICABLE("97511"),
    TRANSACTION_TRANSFER_RECEIVER_ACCOUNT_REFERENCE_NUMBER_IS_INVALID("97509"),
    TRANSACTION_TRANSFER_RECEIVER_ACCOUNT_REFERENCE_NUMBER_TYPE_IS_INVALID("97514"),
    TRANSACTION_TRANSFER_RECEIVER_FIRST_NAME_IS_INVALID("97507"),
    TRANSACTION_TRANSFER_RECEIVER_LAST_NAME_IS_INVALID("97508"),
    TRANSACTION_TRANSFER_RECEIVER_TAX_ID_IS_INVALID("97506"),
    TRANSACTION_TRANSFER_SENDER_ACCOUNT_REFERENCE_NUMBER_IS_INVALID("97505"),
    TRANSACTION_TRANSFER_SENDER_ACCOUNT_REFERENCE_NUMBER_TYPE_IS_INVALID("97513"),
    TRANSACTION_TRANSFER_SENDER_FIRST_NAME_IS_INVALID("97503"),
    TRANSACTION_TRANSFER_SENDER_LAST_NAME_IS_INVALID("97504"),
    TRANSACTION_TRANSFER_SENDER_TAX_ID_IS_INVALID("97502"),
    TRANSACTION_TRANSFER_TYPE_IS_INVALID("97501"),
    ...
    VERIFICATION_THREE_D_SECURE_PASS_THRU_NETWORK_DOES_NOT_MATCH_PAYMENT_INSTRUMENT("942139"),
    VERIFICATION_THREE_D_SECURE_PASS_THRU_NETWORK_DOES_NOT_SUPPORT_CURRENCY("942129"),
    VERIFICATION_THREE_D_SECURE_PASS_THRU_NETWORK_DOES_NOT_SUPPORT_MERCHANT_ACCOUNT_CURRENCY("942130"),
    VERIFICATION_THREE_D_SECURE_PASS_THRU_NETWORK_IS_INVALID("942128"),
