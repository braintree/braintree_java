...
public class Nonce {
  ...
  public static final String TransactableBusiness = "fake-valid-business-nonce";
  public static final String TransactableCommercial = "fake-valid-commercial-nonce";
  public static final String TransactableConsumer = "fake-valid-consumer-nonce";
  public static final String TransactableCorporate = "fake-valid-corporate-nonce";
  ...
  public static final String TransactablePurchase = "fake-valid-purchase-nonce";
